...
**Olyx** is a collection of beautifully designed, accessible, and composable React components. Built on top of [Base UI](https://base-ui.com/) and styled with pure CSS custom properties, it's designed for you to copy, paste, and own.

We believe Base UI is the strongest foundation for modern React applications. We've taken its accessible, unstyled primitives and layered on a design system inspired by Material Design 3 — ready to ship, right out of the box.
...
- **Endless customization** — Need to change something? Edit the file.
