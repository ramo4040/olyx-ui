---
title: Styling
description: Learn how to style Olyx components using CSS and data attributes — zero Tailwind, zero class collisions, full control.
---
...
| `.btn.btn-primary` | 0,2,0 | Two classes — harder to override |
| `.btn.btn-primary.btn-filled` | 0,3,0 | Three classes — good luck |
| `[data-ui="button"]` | 0,1,0 | Single attribute — same as one class |
...
| `tokens` | 6 (highest) | Design tokens | Colors, spacing, typography, radii — CSS custom properties |
