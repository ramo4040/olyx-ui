---
title: Autocomplete
description: Provide intelligent suggestions as users type in an input field for faster data entry and improved discoverability.
...
```bash
npx shadcn@latest add @olyx/autocomplete
```
