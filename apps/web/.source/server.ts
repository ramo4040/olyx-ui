...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "(root)/meta.json": __fd_glob_1, "components/meta.json": __fd_glob_2, }, {"components/accordion.mdx": __fd_glob_3, "(root)/index.mdx": __fd_glob_4, });