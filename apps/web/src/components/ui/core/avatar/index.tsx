...
const AvatarFallback = ({
	...
	return (
		<AvatarPrimitive.Fallback ui-slot="avatar-fallback" {...props}>
			{children}
...
const AvatarImage = ({ children, ...props }: AvatarPrimitive.Image.Props) => {
	return (
		<AvatarPrimitive.Image ui-slot="avatar-image" {...props}>
			{children}
...
const AvatarBadge = ({ status = "online", ...props }: AvatarBadgeProps) => {
	return <span ui-slot="avatar-status" data-status={status} {...props} />;
};

const AvatarGroupCount = ({ ...props }: React.ComponentProps<"div">) => {
	return <div ui-slot="avatar-group-count" {...props} />;
};

const AvatarGroup = ({ ...props }: React.ComponentProps<"div">) => {
	return <div ui-slot="avatar-group" {...props} />;
};
