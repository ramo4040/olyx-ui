...
export default function Particle() {
  return (
    <ScrollArea scrollFade style={{ height: 200 }}>
      <div>
      ...
      <div>
        ...
        it down the hole without a second thought, tumbling through a tunnel of
        clocks and teacups into a world where nothing was quite what it seemed.
      </div>
    </ScrollArea>
  );
}
